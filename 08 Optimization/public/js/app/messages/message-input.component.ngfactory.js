...
export function viewFactory_MessageInputComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_MessageInputComponent === null)) {
        (renderType_MessageInputComponent = viewUtils.createRenderComponentType('F:/Udemy/MEAN/Angular2-and-NodeJS/08 Optimization/assets/app/messages/message-input.component.html', 0, import9.ViewEncapsulation.None, styles_MessageInputComponent, {}));
    }
