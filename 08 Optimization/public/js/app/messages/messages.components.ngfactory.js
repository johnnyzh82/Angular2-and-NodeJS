...
import * as import3 from './messages.components';
...
export function viewFactory_MessagesComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_MessagesComponent === null)) {
        (renderType_MessagesComponent = viewUtils.createRenderComponentType('F:/Udemy/MEAN/Angular2-and-NodeJS/08 Optimization/assets/app/messages/messages.components.ts class MessagesComponent - inline template', 0, import8.ViewEncapsulation.None, styles_MessagesComponent, {}));
    }
    return new _View_MessagesComponent0(viewUtils, parentInjector, declarationEl);
}
//# sourceMappingURL=messages.components.ngfactory.js.map